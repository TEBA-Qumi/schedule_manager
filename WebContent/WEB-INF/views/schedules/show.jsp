            ...
            <c:when test="${schedule != null}">
                ...
                <table>
                    <tbody>
                        <tr>
                            <th>名前</th>
                            <td><c:out value="${schedule.account.name}" /></td>
                        </tr>
                        <tr>
                            <th>日付</th>
                            <td><fmt:formatDate value="${schedule.schedule_date}" pattern="yyyy-MM-dd" /></td>
                        </tr>
                        <tr>
                            <th>内容</th>
                            <td>
                                <pre><c:out value="${schedule.content}" /></pre>
                            </td>
                        </tr>
                        <tr>
                            <th>公開範囲</th>
                ...
                <c:if test="${sessionScope.login_account.id == schedule.account.id}">
                    <p><a href="<c:url value="/schedules/edit?id=${schedule.id}" />">この日報を編集する</a></p>
                </c:if>
            </c:when>
            <c:otherwise>
